<template>
    <div class="app-container calendar-list-container">
        ...
        <div class="filter-container">
            <el-button @click="openForm('add')" size="small" type="primary">
        ...
        <el-table :data="list" ref="labelTable" v-loading.body="listLoading" border highlight-current-row style="width: 100%">
            ...
            <el-table-column align="center" label="操作" min-width="200px">
                <template slot-scope="scope">
                    <el-button size="small" v-waves type="primary" @click="openForm('edit', scope.row)" class="edit-label">编辑
                    </el-button>
                    <el-button size="small" v-waves type="danger" @click="delLabel(scope.row.id)">删除
                    </el-button>
                    <el-button size="small" v-waves type="success" @click="goToMailList(scope.row.id)">查看
                    </el-button>
                </template>
            </el-table-column>
        </el-table>
        ...
        <el-dialog :title="labelOperation | operationFilter" :visible.sync="formVisible">
            ...
            <div slot="footer" class="dialog-footer">
                <el-button v-waves @click="formVisible = false">取 消</el-button>
                <el-button v-waves type="primary" @click="submit()">确 定</el-button>
            </div>
        </el-dialog>
    </div>
</template>
