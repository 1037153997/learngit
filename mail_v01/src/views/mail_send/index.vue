<template>
  <div v-loading.body="loading" class="app-container">
    ...
    <el-row :gutter="10">
      ...
      <el-col :span="2">
        <el-button type="danger" v-waves @click="cleanTarget">清空</el-button>
      </el-col>
    </el-row>
    ...
    <el-row :gutter="10">
      ...
      <el-col :span="2">
        <el-button type="danger" v-waves @click="cleanCopy">清空</el-button>
      </el-col>
    </el-row>
    ...
    <el-row :gutter="20">
      ...
      <el-col :span="12">
        <el-button type="primary" v-waves :disabled="isRecording" @click="startRecorder" size="small">开始录音</el-button>
        <el-button type="primary" v-waves :disabled="!isRecording" @click="stopRecorder" size="small">结束录音</el-button>
...
<!--            <icon-svg icon-class="delete11" class="del-audio" @click.native="delAudio(index)"/>-->
    ...
    <el-row>
      <el-col :span="12" :offset="9">
        <el-button v-waves type="primary" @click="sendSubmit">发送</el-button>
        <el-button v-waves type="primary" @click="saveAsDraft">保存</el-button>
      </el-col>
    </el-row>
