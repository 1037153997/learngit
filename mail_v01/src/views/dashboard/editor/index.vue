...
<!--                <span class="pan-info-roles" v-for="item in roles">{{item}}</span>-->
            ...
            <a href="http://www.haiwu.com/" target="_blank" class="github-corner" aria-label="View source on Github">
                <svg width="80" height="80" viewBox="0 0 250 250" style="fill:#4AB7BD; color:#fff; position: absolute; top: 60px; border: 0; right: 0;" aria-hidden="true">
...
<!--                <span class="display_name">{{name}}</span>-->
                <span class="display_name">随便起的名字</span>
                ...
                <div class="unread-mail-wrapper">
                    <template v-if="unreadMails.length!=0">
                        <div class="unread-mail-item" v-for="mail in unreadMails">
                            ...
                            <el-tag type="danger">{{mail.receiveDate}}</el-tag>
...
export default {
//   name: 'dashboard',
  components: { PanThumb, countTo, WeeklyUsing },
