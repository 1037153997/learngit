    ...
    <div class="app-container calendar-list-container">
        ...
        <div class="filter-container">
            <el-tooltip class="item" effect="dark" content="新增" placement="top-start">
                <el-button v-waves @click="openForm('add')" size="small" type="primary" class="tool-item filter-item btn-add">
                  <i class="fa fa-plus" aria-hidden="true" style="margin: 0 auto"></i>
                </el-button>
            </el-tooltip>
            <el-tooltip class="item" effect="dark" content="发送选择的联系人" placement="bottom-start">
                <el-button v-waves @click="sendMail()" size="small" type="primary" class="tool-item filter-item btn-send">
            ...
            <el-tooltip class="item" effect="dark" content="发送全部" placement="top-start">
                <el-button v-waves @click="sendMail('all')" size="small" type="primary" class="tool-item filter-item btn-send-to-all">
                  <i class="fa fa-paper-plane" aria-hidden="true" style="margin: 0 auto"></i>
                </el-button>
            </el-tooltip>
            <el-tooltip class="item" effect="dark" content="删除选中的联系人" placement="bottom-start">
                <el-button v-waves @click="del" type="danger" size="small" class="tool-item filter-item btn-del">
                  <i class="fa fa-trash" aria-hidden="true" style="margin: 0 auto"></i>
                </el-button>
            </el-tooltip>

            <el-input @keyup.enter.native="handleFilter" size="small" style="width: 200px;" class="filter-item" placeholder="姓名" v-model="listQuery.name">
            </el-input>

            <el-input @keyup.enter.native="handleFilter" size="small" style="width: 200px;" class="filter-item" placeholder="邮箱" v-model="listQuery.mail">
            </el-input>
            ...
            <el-button class="filter-item" size="small" type="text" v-waves @click="handleDownload">
              <i class="fa fa-download" aria-hidden="true" style="margin: 0 auto"></i>
              <span>导出</span>
            </el-button>
        </div>
            ...
            <el-col :span="8" v-for="(item, index) in list" :key="index" class="card-row">
                <div class="el-card" ref="card" @click="toggleSelect(item, index, $event)">
                    ...
                    <div class="constact-right">
                        <p>
                          <i class="fa fa-user" style="color: #F38181; margin-right: 10px" aria-hidden="true"/>{{item.name}}
                            <el-button v-waves @click="openForm('edit', item, $event)" type="primary" size="mini" class="card-btn card-btn-edit">
                              <i class="fa fa-pencil" style="margin: 0 auto" aria-hidden="true"></i>
                            </el-button>
                            <el-button v-waves @click="sendMail(null, item, $event)" type="primary" size="mini" class="btn-send-mail">
                              <i class="fa fa-paper-plane" style="margin: 0 auto" aria-hidden="true"></i>
                            </el-button>
                        </p>
